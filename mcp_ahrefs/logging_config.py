"""Logging configuration for MCP Ahrefs MCP server"""
...
from mcp_ahrefs.decorators.sqlite_logger import initialize_sqlite_logging
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the MCP Ahrefs MCP server"""
    ...
    project_logger = logging.getLogger("mcp_ahrefs")
    ...
    log_file = log_path / "mcp_ahrefs.log"
...
logger = logging.getLogger("mcp_ahrefs")