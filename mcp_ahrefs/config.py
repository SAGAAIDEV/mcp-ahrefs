"""Configuration management for MCP Ahrefs
...
class ServerConfig:
    ...
    # Server settings
    name: str = "MCP Ahrefs"
    description: str = "Ahrefs MCP Server for SAAGA"
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("mcp_ahrefs"))
        if self.data_dir is None:
            self.data_dir = Path(platformdirs.user_data_dir("mcp_ahrefs"))
        if self.log_dir is None:
            self.log_dir = Path(platformdirs.user_log_dir("mcp_ahrefs"))
        ...
        self.log_file_path = self.log_dir / "mcp_ahrefs.log"
        self.database_path = self.data_dir / "mcp_ahrefs.db"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        return cls(
            name=data.get("name", "MCP Ahrefs"),
            description=data.get("description", "Ahrefs MCP Server for SAAGA"),
...
class UIConfig:
    ...
    # UI settings
    page_title: str = "MCP Ahrefs Admin"
    page_icon: str = "🔧"
    layout: str = "wide"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "UIConfig":
        ...
        return cls(
            page_title=data.get("page_title", "MCP Ahrefs Admin"),
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("mcp_ahrefs")),
        "data_dir": str(platformdirs.user_data_dir("mcp_ahrefs")),
        "log_dir": str(platformdirs.user_log_dir("mcp_ahrefs")),
        "cache_dir": str(platformdirs.user_cache_dir("mcp_ahrefs")),
    }
