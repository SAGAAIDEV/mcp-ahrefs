"""
Streamlit Admin UI for MCP Ahrefs
...
Run with: streamlit run mcp_ahrefs/ui/app.py
"""
...
try:
    ...
    def get_project_info():
        return {"name": "MCP Ahrefs", "version": "0.1.0"}

# Page configuration
st.set_page_config(
    page_title="MCP Ahrefs Admin",
    page_icon="🛠️",
    layout="wide",
