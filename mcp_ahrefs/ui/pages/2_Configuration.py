"""
Configuration management page for MCP Ahrefs Admin UI
...
def render_configuration_form(config):
    ...
    with st.form("config_form"):
        ...
        with col1:
            ...
            server_name = st.text_input("Server Name", value=server_config.get("name", "MCP Ahrefs"))
...
def handle_export_config(config):
    ...
    st.download_button(
        ...
        data=config_json,
        file_name="mcp_ahrefs_config.json",
...
def render_environment_variables():
    ...
    env_vars = {
        "MCP_AHREFS_LOG_LEVEL": "INFO",
        "MCP_AHREFS_PORT": "3001",
        "MCP_AHREFS_CONFIG_PATH": system_info.get("config_path", "~/.config/mcp_ahrefs"),
        "MCP_AHREFS_LOG_PATH": system_info.get("log_path", "~/.local/share/mcp_ahrefs"),
...
def main():
    ...
    # Page header
    st.title("⚙️ MCP Ahrefs Configuration")
    ...
    with col2:
        ...
        st.download_button(
            ...
            data=config_yaml,
            file_name="mcp_ahrefs_config.yaml",
