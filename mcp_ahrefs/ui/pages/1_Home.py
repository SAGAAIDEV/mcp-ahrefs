"""
Home/Dashboard page for MCP Ahrefs Admin UI
...
def render_project_overview():
    ...
    with col1:
        ...
        **Project Details:**
        ...
        - **Author:** Jakub Raczyński
        - **Email:** jakub.raczynski@ragnarson.com
        """)
...
def main():
    """Main page content"""
    # Page header
    st.title("🏠 MCP Ahrefs Admin Dashboard")
    ...
    # Footer
    st.markdown("---")
    st.caption(f"MCP Ahrefs Admin UI • Generated with SAAGA MCP Server Cookie Cutter")
